...
```
go run mattermost.go -assign_role -email="user@example.com" -role="system_admin"
```
...
Alternatively, if you're writing clientside code, you can run only the clientside unit tests by using `make test-client`.
